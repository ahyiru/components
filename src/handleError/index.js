...
${info}`.replace(/\r|\n|\r\n/g, "<br/>");
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { style: { padding: "15px 20px", backgroundColor: "#fff", wordWrap: "break-word" }, children: [
    (0,_str2React__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(str, { style: { color: "red" } }),
...
const HandleError = ({ children, report }) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_errorBoundary__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, { ref: boundaryRef, fallback: (error, info) => (0,_loadError__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)({ error, info }), errorReport: report, children });
};
