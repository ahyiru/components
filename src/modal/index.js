...
// NAMESPACE OBJECT (decoupled): css ../huxy/components/modal/index.module.less
...
;// css ../huxy/components/modal/index.module.less
const _O = "_533_BFqfB";
const NE = "_533_OMsUQ";
const R8 = "_533_R3M5c";
const ho = "_533_KxGj5";
...
const Modal = ({ open, close, hasMask = true, cancelText = "\u53D6\u6D88", submit, submitText = "\u786E\u5B9A", title = "Modal \u5F39\u7A97", className, children, delay = 250, ...rest }) => {
  const cls = ["modal-wrap", open ? "open" : "", ...className?.split(" ") ?? []].filter(Boolean).map((c) => index_module_namespaceObject[c]).join(" ");
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(mask/* default */.A, { open, close, delay, hasMask, className: "huxy-modal", children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: cls, ...rest, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: QN, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: k3, children: title }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: Y8, children }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: ww, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `${HM} ${kb}`, onClick: (e) => close?.(e), children: cancelText }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `${HM} ${pG}`, onClick: (e) => submit?.(e), children: submitText })
    ] })
  ] }) }) });
};
