...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ components_anico; }
});

;// CONCATENATED MODULE: ../huxy/components/anico/index.less
// extracted by mini-css-extract-plugin
/* harmony default export */ var anico = ({"anico":"nstud","hline":"IZUmD","close":"ylzxZ","right":"Wy_0M","bottom":"bdjKS","play":"QPs9T","pause":"tx7CH"});
...
const Index = props => /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
  className: anico.anico,
  children: /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
    className: [anico.hline, ...(props.type || '').split(' ').map(cls => anico[cls]).filter(Boolean)].join(' ')
  })
});

/* harmony default export */ var components_anico = (Index);
}();
