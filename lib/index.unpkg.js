...
const Drawer = ({ open, close, footer, header, className, style, children, width = "300px", mountNode, position = "right", relative }) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(components_mask, { open, close, delay: 250, hasMask: true, relative, mountNode, className: "huxy-drawer", children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: cls, style: { width, position: relative ? "absolute" : "fixed", "--footerHeight": footer ? "44px" : "0px", ...style }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: components_drawer["drawer-container"], children: [
