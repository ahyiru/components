import*as Lr from"react";import*as se from"react-dom";var Fr={269:(o,f,i)=>{i.d(f,{Z:()=>_});var g=i(601),h=i.n(g),u=i(609),d=i.n(u),c=d()(h());c.push([o.id,`/*@height:2px;
@width:18px;
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(j))))," */")),u.styleTagTransform(c,h,u.options)}function i(h){if(h.parentNode===null)return!1;h.parentNode.removeChild(h)}function g(h){if(typeof document>"u")return{update:function(){},remove:function(){}};var u=h.insertStyleElement(h);return{update:function(c){f(u,h,c)},remove:function(){i(u)}}}o.exports=g},464:o=>{function f(i,g){if(g.styleSheet)g.styleSheet.cssText=i;else{for(;g.firstChild;)g.removeChild(g.firstChild);g.appendChild(document.createTextNode(i))}}o.exports=f},810:o=>{var f=g=>{var h={};return C.d(h,g),h},i=g=>()=>g;o.exports=Lr}},ce={};function C(o){var f=ce[o];if(f!==void 0)return f.exports;var i=ce[o]={id:o,exports:{}};return Fr[o](i,i.exports,C),i.exports}C.n=o=>{var f=o&&o.__esModule?()=>o.default:()=>o;return C.d(f,{a:f}),f},C.d=(o,f)=>{for(var i in f)C.o(f,i)&&!C.o(o,i)&&Object.defineProperty(o,i,{enumerable:!0,get:f[i]})},C.o=(o,f)=>Object.prototype.hasOwnProperty.call(o,f),C.nc=void 0;var z={};(()=>{C.d(z,{PC:()=>Rt,rK:()=>fe,lr:()=>we,JX:()=>Nt,dy:()=>Ft,Ud:()=>Ue,mH:()=>He,SV:()=>Yt,Hn:()=>Je,rj:()=>qe,V7:()=>tr,AN:()=>qt,zd:()=>Dt,BQ:()=>or,Ur:()=>Br,u_:()=>ar,s_:()=>lr,h_:()=>Tt,X2:()=>Qt,$j:()=>Ot,GK:()=>xr,u:()=>Vt,mp:()=>vr,C2:()=>Xt,pC:()=>Ze,ff:()=>ne,d2:()=>jt,Uw:()=>ur});var o=C(322),f=C(62),i=C.n(f),g=C(36),h=C.n(g),u=C(793),d=C.n(u),c=C(892),_=C.n(c),j=C(173),v=C.n(j),O=C(464),T=C.n(O),w=C(269),I={};I.styleTagTransform=T(),I.setAttributes=_(),I.insert=d().bind(null,"head"),I.domAPI=h(),I.insertStyleElement=v();var Z=i()(w.Z,I);const U=w.Z&&w.Z.locals?w.Z.locals:void 0,Rt=t=>(0,o.jsx)("span",{className:U.anico,children:(0,o.jsx)("span",{className:[U.hline,...(t.type||"").split(" ").map(e=>U[e]).filter(Boolean)].join(" ")})});var m=C(810);const de=t=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(t),he=t=>new Promise((e,r)=>{const a=new FileReader;a.readAsDataURL(t),a.addEventListener("load",()=>e(a.result)),a.addEventListener("error",n=>r(n))}),ue=async t=>{if(!de(t))return t;const r=await(await fetch(decodeURIComponent(t))).blob();return await he(r)},pe=t=>{const[e,r]=(0,m.useState)(t);return(0,m.useEffect)(()=>{(async n=>{const l=await ue(n);r(l)})(t)},[t]),e},fe=({src:t,...e})=>{const r=pe(t);return(0,o.jsx)("img",{...e,src:r})};var xe=t=>{var e={};return C.d(e,t),e},Eo=t=>()=>t;const It=xe({createPortal:()=>se.createPortal,flushSync:()=>se.flushSync}),me=(t,e)=>{const r=(0,m.useRef)();(0,m.useEffect)(()=>{r.current=t},[t]),(0,m.useEffect)(()=>{if(e){const a=setInterval(()=>r.current(),e);return()=>clearInterval(a)}},[e])},K=()=>![typeof window,typeof document].includes("undefined"),At=t=>Object.prototype.toString.call(t).slice(8,-1).toLowerCase(),St=t=>At(t).indexOf("element")>-1,q=(t=null)=>K()?St(t)?{width:t.clientWidth,height:t.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},Wt=(t=()=>{},e=60)=>{let r=null;return function(...a){clearTimeout(r),r=setTimeout(()=>t.apply(this,a),e)}},ye=(t,e)=>Object.prototype.hasOwnProperty.call(t??{},e),H=t=>ye(t,"current"),Bt=(t,e)=>{const r=[],a=t.children??[];for(let n=0,l=a.length;n<l;n++){const s=a[n];s.className.indexOf(e)>-1&&r.push(s)}return r.length===0?null:r.length===1?r[0]:r},ge=(t,e)=>{getComputedStyle(t).position==="static"&&(t.style.position="relative");const r=document.createElement("object");return r.setAttribute("style","display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0"),r.setAttribute("class","resize-sensor"),r.onload=()=>{r.contentDocument.defaultView.addEventListener("resize",e,!1),e()},r.type="text/html",t.appendChild(r),r.data="about:blank",r},_e=(t,e=60)=>{if(!K())return;t=H(t)?t.current:t??document.body;let r=Bt(t,"resize-sensor"),a=[];const n=Wt(()=>a.map(x=>x(t)),e),l=x=>{Bt(t,"resize-sensor")||(r=ge(t,n)),a.indexOf(x)===-1&&a.push(x)},s=x=>{const y=a.indexOf(x);y!==-1&&a.splice(y,1),a.length===0&&r&&p()},p=()=>{r&&r.parentNode&&(r.contentDocument&&r.contentDocument.defaultView.removeEventListener("resize",n,!1),r.parentNode.removeChild(r),r=void 0,a=[])};return{element:t,bind:l,unbind:s,destroy:p}},Ut=(t={})=>{const e=(0,m.useRef)(0),[r,a]=(0,m.useState)(t),n=(0,m.useCallback)(l=>{cancelAnimationFrame(e.current),e.current=requestAnimationFrame(()=>a(l))},[]);return(0,m.useEffect)(()=>()=>cancelAnimationFrame(e.current),[]),[r,n]},be=(t=null,e=60)=>{const r=H(t)?t.current:t,{bind:a,destroy:n}=_e(r,e),[l,s]=Ut(q(r));return(0,m.useEffect)(()=>(a(()=>r&&s(q(r))),()=>n()),[r]),l};var xt=C(528),tt={};tt.styleTagTransform=T(),tt.setAttributes=_(),tt.insert=d().bind(null,"head"),tt.domAPI=h(),tt.insertStyleElement=v();var Wo=i()(xt.Z,tt);const G=xt.Z&&xt.Z.locals?xt.Z.locals:void 0,we=({children:t,active:e=0,delay:r=5e3,className:a,...n})=>{const[l,s]=(0,m.useState)(e+1),[p,x]=(0,m.useState)(!1),y=(0,m.useRef)(),E=(0,m.useRef)(""),{width:k}=be(y);t=Array.isArray(t)?t:[t];const b=t[0],R=[t[t.length-1],...t,b],P=R.length;me(()=>{let D=l+1;D=D===P?1:D,E.current&&(E.current=""),s(D),D===P-1&&setTimeout(()=>{E.current="none",s(1)},500)},p?null:r);const S=(D,W)=>{W.stopPropagation(),E.current="",s(D),(0,It.flushSync)(()=>x(!0)),x(!1)},A={width:`${P*k}px`,transform:`translateX(${-k*l}px)`,transition:E.current};return(0,o.jsxs)("div",{className:`${G["huxy-carousel"]}${a?` ${a}`:""}`,...n,ref:y,children:[(0,o.jsx)("div",{className:G["huxy-carousel-wrap"],style:A,children:R.map((D,W)=>(0,o.jsx)("div",{className:`${G["carousel-item"]} ${l===W?G.active:""}`,style:{width:`${k}px`},children:D},`huxy-carousel-${W}`))}),(0,o.jsx)("div",{className:G["carousel-switch"],children:t.map((D,W)=>(0,o.jsx)("span",{className:`${G.dot} ${l===W+1?G.active:""}`,onClick:N=>S(W+1,N)},`huxy-carousel-switch-${W}`))})]})},pt=(t,e)=>{let r="",a="";if(typeof e=="number"&&(r=`col-${t}-${e}`),typeof e=="object"){const{span:n,offset:l}=e;r=n?`col-${t}-${n}`:"",a=l?`offset-${t}-${l}`:""}return{sp:r,os:a}},Nt=(0,m.forwardRef)(({span:t,offset:e,xl:r,lg:a,md:n,sm:l,xs:s,style:p,width:x,auto:y,offsetWidth:E="0px",className:k,...b},M)=>{const R=k?` ${k}`:"",P=`col-${t||12}`,S=e?`offset-${e}`:"",{sp:A,os:D}=pt("xs",s),{sp:W,os:N}=pt("sm",l),{sp:Y,os:B}=pt("md",n),{sp:X,os:L}=pt("lg",a),{sp:V,os:F}=pt("xl",r),Q=[P,V,X,Y,W,A,S,F,L,B,N,D].filter(Boolean).join(" "),zt=y?{width:"auto",flex:1,maxWidth:`calc(100% - ${E})`}:{width:x};return(0,o.jsx)("div",{className:`${Q}${R}`,...b,style:{...zt,...p},ref:M})}),ve=()=>{const t=(0,m.useRef)(!0);return t.current?(t.current=!1,!0):!1},ke=(t,e=[])=>{const r=ve();(0,m.useEffect)(()=>{if(!r)return t()},e)},Lt=(t,e=450)=>{const[r,a]=(0,m.useState)(t);return ke(()=>{let n;return t||e===0?a(t):n=setTimeout(()=>a(t),e),()=>n&&clearTimeout(n)},[t]),[r,a]},Tt=({children:t,mountNode:e=document.body})=>(0,It.createPortal)(t,e),Ee={position:"fixed",top:0,left:0,bottom:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",zIndex:9999},Ce={position:"fixed",top:0,left:0,bottom:0,right:0,background:"rgba(0, 0, 0, 0.5)",zIndex:1e4},Pe=document.body,Dt=({open:t,close:e,delay:r=300,children:a,mountNode:n,hasMask:l=!0,style:s,className:p="h-mask",relative:x})=>{const[y]=Lt(t,r);(n??Pe).style.overflow=y?"hidden":"";const E=x?"absolute":"fixed";return(0,o.jsx)(Tt,{mountNode:n,children:(0,o.jsx)("div",{children:y?(0,o.jsxs)("div",{className:p,style:{...Ee,position:E},children:[l?(0,o.jsx)("div",{style:{...Ce,position:E},onClick:k=>e?.(k)}):null,m.Children.map(a,k=>(0,m.isValidElement)(k)?(0,m.cloneElement)(k,{style:{position:"relative",zIndex:100001,...k.props.style}}):k)]}):null})})};var mt=C(434),et={};et.styleTagTransform=T(),et.setAttributes=_(),et.insert=d().bind(null,"head"),et.domAPI=h(),et.insertStyleElement=v();var Zo=i()(mt.Z,et);const J=mt.Z&&mt.Z.locals?mt.Z.locals:void 0,Ft=({open:t,close:e,footer:r,header:a,className:n,style:l,children:s,width:p="300px",mountNode:x,position:y="right",relative:E})=>{const k=["drawer-wrap",y,t?"open":"",...n?.split(" ")??[]].filter(Boolean).map(b=>J[b]).join(" ");return(0,o.jsx)(Dt,{open:t,close:e,delay:250,hasMask:!0,relative:E,mountNode:x,className:"huxy-drawer",children:(0,o.jsx)("div",{className:k,style:{width:p,position:E?"absolute":"fixed","--footerHeight":r?"44px":"0px","--headerHeight":a?"44px":"0px",...l},children:(0,o.jsxs)("div",{className:J["drawer-container"],children:[a?(0,o.jsxs)("div",{className:J["drawer-header"],children:[y==="right"?(0,o.jsx)("span",{className:`link ${J["ico-close"]}`,onClick:b=>e?.(b)}):null,(0,o.jsx)("div",{children:a}),y==="left"?(0,o.jsx)("span",{className:`link ${J["ico-close"]}`,onClick:b=>e?.(b)}):null]}):null,(0,o.jsx)("div",{className:J["drawer-content"],children:s}),r?(0,o.jsx)("div",{className:J["drawer-footer"],children:r}):null]})})})},ze=(t,e,r="click")=>{(0,m.useEffect)(()=>{const a=l=>{const s=H(t)?t.current:t;s?.contains&&!s.contains(l.target)&&e(l)},n=typeof r=="string"?[r]:r;return n.map(l=>{document.addEventListener(l,a,!1)}),()=>{n.map(l=>{document.removeEventListener(l,a,!1)})}},[t,e,r])},Se=t=>t?.$$typeof&&typeof t.$$typeof=="symbol"&&t.$$typeof.description==="react.element",Te=(t="")=>t.replace(/^\S/,e=>e.toUpperCase()),rt=t=>{if(K())return t=H(t)?t.current:t??document.body,t.getBoundingClientRect?.()},De=t=>{if(!K())return;const e=document.createElement("div");return e.innerHTML=t,e.children[0]},ft=(t,e={},r=!1)=>{if(St(t)){if(r){let a="";Object.keys(e).map(n=>{a+=`${n}: ${e[n]};`}),t.style=a;return}Object.keys(e).map(a=>t.style.setProperty(a,e[a]))}},je=(t=350,e="ms")=>({ms:t*1,s:t*1e3,m:t*6e4,h:t*36e5,d:t*864e5})[e]??t,Oe=(t=350,e="ms")=>new Promise(r=>setTimeout(r,je(t,e))),qo=(t=100)=>{const e=Date.now();for(;Date.now()-e<=t;);},Me=Oe,Re=async(t,e=15)=>{if(!K())return;if(typeof t=="string"&&(t=De(t)),t=H(t)?t.current:t,!St(t))return{};const r=t.cloneNode(!0);ft(r,{"pointer-events":"none","z-index":-1,opacity:0,display:"block",animation:"none"}),t.parentNode.appendChild(r),await Me(e);const a=rt(r);return t.parentNode.removeChild(r),a},Ie=/(\s|^)(huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br)(\s|$)/,Ae=/huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br/,Ht=(t,e)=>{e=`huxy-drop-arrow-${e}`;const r=t.getAttribute("class")??"";Ie.test(r)?t.setAttribute("class",r.replace(Ae,e)):t.setAttribute("class",`${r} ${e}`)},Kt=async(t,e,r)=>{const{left:a,right:n,top:l,bottom:s}=rt(t),{width:p,height:x}=q(),{width:y,height:E}=await Re(e);if(n<0||s<0||a>p||l>x)return{};if(r==="vertical"){const k={left:a+"px",top:s+10+"px",right:"auto",bottom:"auto"};let b="lt";a+y>p&&(k.left=n-y+"px",b="rt"),s+10+E>x&&(k.top=l-10-E+"px",b=b==="lt"?"lb":"rb"),ft(e,k),Ht(e,b)}else{const k={left:n+10+"px",top:l+"px",right:"auto",bottom:"auto"};let b="tl";n+10+y>p&&(k.left=a-10-y+"px",b="tr"),l+E>x&&(k.top=s-E+"px",b=b==="tl"?"bl":"br"),ft(e,k),Ht(e,b)}},We=(t,e,r="horizontal")=>{const a=Wt(Kt),n=()=>a(t,e,r);window.addEventListener("scroll",n,!1),window.addEventListener("resize",n,!1);const l=()=>{window.removeEventListener("scroll",n),window.removeEventListener("resize",n),ft(e,{left:"",top:"",right:"",bottom:""})};return Kt(t,e,r),l},Be=({open:t,delay:e=280,children:r,mountNode:a,style:n,...l})=>{const[s]=Lt(t,e);return(0,o.jsx)(Tt,{mountNode:a,children:(0,o.jsx)("div",{children:(0,o.jsx)("div",{style:{...n,display:s?"block":"none"},...l,children:r})})})};var yt=C(503),ot={};ot.styleTagTransform=T(),ot.setAttributes=_(),ot.insert=d().bind(null,"head"),ot.domAPI=h(),ot.insertStyleElement=v();var oa=i()(yt.Z,ot);const Zt=yt.Z&&yt.Z.locals?yt.Z.locals:void 0,Ue=({trigger:t="click",type:e,dropList:r,className:a,children:n,targetProps:l,...s})=>{const[p,x]=(0,m.useState)(!1),y=(0,m.useRef)(),E=(0,m.useRef)(),k=(0,m.useRef)();ze(y,S=>p&&x(!1),[...new Set(["click",t.toLowerCase()])]),(0,m.useEffect)(()=>()=>k.current?.(),[]);const b=S=>{S.preventDefault(),x(!0),k.current=We(y.current,E.current,e)},M={[`on${Te(t)}`]:b},R=["drop-wrap",p?"open":"",a].filter(Boolean).map(S=>Zt[S]).join(" "),P=Se(r)?r:r?.(()=>x(!1),p);return(0,o.jsxs)("span",{ref:y,className:Zt["drop-target"],...l,...M,children:[n,(0,o.jsx)(Be,{open:p,className:"huxy-drop",children:(0,o.jsx)("div",{ref:E,className:R,...s,children:P})})]})},Ne=(t,e,r)=>{if(!K())return;r=H(r)?r.current:r??document.body;const a=document.createElement("span");a.setAttribute("style","pointer-events: none; z-index: -1; opacity: 0;"),e&&ft(a,e),a.innerText=(t??"").replace(/[\r\n]/g,""),r.appendChild(a);const n=a.getBoundingClientRect();return r.removeChild(a),n};var gt=C(918),at={};at.styleTagTransform=T(),at.setAttributes=_(),at.insert=d().bind(null,"head"),at.domAPI=h(),at.insertStyleElement=v();var ia=i()(gt.Z,at);const $t=gt.Z&&gt.Z.locals?gt.Z.locals:void 0,Vt=({title:t,placement:e="topRight",children:r,ellipsis:a,className:n,...l})=>(0,o.jsx)("span",{className:`${$t[`huxy-tooltip-${e}`]}${n?` ${n}`:""}`,tooltip:t??r,...l,children:(0,o.jsx)("span",{className:a?$t.ellipsis:"",children:r})}),Le={overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",display:"inline-block",width:"100%"},Fe=t=>{const{children:e,style:r}=t,a=typeof e=="string",n=a?e:e?.props?.title??e?.props?.children,l=(0,m.useRef)(),[s,p]=(0,m.useState)(!0);return(0,m.useEffect)(()=>{if(l.current){const{width:x}=Ne(n,null,l.current.parentNode),{width:y}=rt(l.current),E=~~x>~~y;E!==s&&p(E)}},[n]),(0,o.jsx)("span",{ref:l,style:{display:"flex",width:"100%",...r},children:s?a?(0,o.jsx)(Vt,{...t,ellipsis:!0}):(0,o.jsx)("span",{style:Le,children:e}):a?e:e?.props?.children})},He=t=>t.children==null?"":(0,o.jsx)(Fe,{...t});class Yt extends m.default.Component{state={error:null};static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e,r){const{errorReport:a}=this.props;typeof a=="function"&&a({error:e,info:r.componentStack})}render(){const{error:e}=this.state,{fallback:r,children:a}=this.props;return e?r?.(e)??e:a}}const Xt=t=>e=>{if(typeof e=="function"||typeof e?.render=="function")return(0,o.jsx)(e,{});if(typeof e=="string"){const r=t?.[e];return r?(0,o.jsx)(r,{}):(0,o.jsx)("i",{className:e})}return e??null},Ke=t=>Xt(t),Ze=t=>({icon:e,defaultIcon:r})=>e?Ke(t)(e):e===!1?null:r,_t=["","webkit","moz","ms"],$e=t=>_t.map(e=>e?`${e}FullscreenElement`:"fullscreenElement").find(e=>t[e]),Ve=t=>_t.map(e=>e?`${e}RequestFullscreen`:"requestFullscreen").find(e=>t[e]),Ye=t=>_t.map(e=>e?`${e}ExitFullscreen`:"exitFullscreen").find(e=>t[e]),Gt=_t.map(t=>`${t}fullscreenchange`),Xe=t=>{if(!K())return;t=H(t)?t.current:t??document.body;const e=$e(document),r=Ve(t),a=Ye(document);document[e]?document[a]?.():t[r]?.()},Ge=t=>K()?(Gt.map(r=>document.addEventListener(r,t,!1)),()=>Gt.map(r=>document.removeEventListener(r,t,!1))):void 0,Jt=t=>(0,o.jsx)("i",{...t,children:"..."}),Je=({panel:t,fullIcon:e=Jt,exitIcon:r=Jt,...a})=>{const n=H(t)?t.current:t,[l,s]=(0,m.useState)();(0,m.useEffect)(()=>{const x=Ge(()=>{s(y=>!y)});return()=>x()},[]);const p=l?r:e;return(0,o.jsx)(p,{onClick:x=>Xe(n),...a})};var bt=C(249),nt={};nt.styleTagTransform=T(),nt.setAttributes=_(),nt.insert=d().bind(null,"head"),nt.domAPI=h(),nt.insertStyleElement=v();var fa=i()(bt.Z,nt);const xa=bt.Z&&bt.Z.locals?bt.Z.locals:void 0,Qe=({gutter:t=10,className:e,overflow:r="hidden",...a},n)=>{const l=e?` ${e}`:"";let s=10;if(Array.isArray(t)){const p=[...t];t=p[0],s=p[1]??p[0]}return(0,o.jsx)("div",{className:"row-wrap",style:{"--gutter":`${Math.floor(t/2)}px`,"--rowgap":`${Math.floor(s/2)}px`,overflow:r},children:(0,o.jsx)("div",{className:`row${l}`,...a,ref:n})})},Qt=(0,m.forwardRef)(Qe),qe=({rowProps:t,colProps:e,children:r,Row:a=Qt,Col:n=Nt})=>{const l=[];return m.Children.map(r,s=>{s&&(s.type?.description==="react.fragment"?l.push(...s.props.children):l.push(s))}),(0,o.jsx)(a,{...t,children:l.map((s,p)=>(0,o.jsx)(n,{...e,...s.props.itemprops,children:s},`huuxy_grid_${p}`))})},jt=(t,e)=>(0,o.jsx)("div",{dangerouslySetInnerHTML:{__html:t},...e}),qt=t=>{const{error:e={},info:r=""}=t||{},{message:a,stack:n,errMsg:l}=e;let s=l||n||e.toString();s=`${s}
${r}`.replace(/\r|\n|\r\n/g,"<br/>"),s=s.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;"),s=s.replace(/\s/g,"&nbsp;");const p=a?.slice(0,120).split(". ").slice(0,2).join(". ");return(0,o.jsxs)("div",{style:{padding:"15px 20px",backgroundColor:"#fff",wordWrap:"break-word"},children:[jt(s,{style:{color:"red"}}),p&&(0,o.jsxs)("a",{style:{display:"inline-block",padding:"15px",color:"#00b4cf"},href:`https://stackoverflow.com/search?q=${p}`,target:"_blank",children:[" ","--> \u53BB\u7F51\u4E0A\u67E5\u627E\u9519\u8BEF\u539F\u56E0\uFF1F"]})]})},tr=({children:t,report:e})=>{const r=(0,m.useRef)();return r.current?.state&&(r.current.state.error=null),(0,o.jsx)(Yt,{ref:r,fallback:(a,n)=>qt({error:a,info:n}),errorReport:e,children:t})},te=(t,e)=>Object.keys(e).map(r=>t.style[r]=e[r]),er=(t,e)=>Object.keys(e).map(r=>t.style[r]=""),rr={overflow:"auto",position:"fixed",zIndex:5555,transition:"all .2s"},ee=({left:t,top:e,width:r,height:a})=>({left:`${t}px`,top:`${e}px`,width:`${r}px`,height:`${a}px`}),re=t=>(0,o.jsx)("i",{...t,children:"..."}),oe=t=>{const{left:e,top:r}=rt(t),{width:a,height:n}=q(t);return{left:e,top:r,width:a,height:n}},or=({panel:t,target:e,fullIcon:r=re,exitIcon:a=re})=>{t=H(t)?t.current:t||document.body;const[n,l]=(0,m.useState)(),s=(0,m.useRef)();(0,m.useEffect)(()=>{s.current={...rr,...ee(oe(t))}},[t]);const p=(y,E)=>{if(y){const b=ee(oe((typeof e=="function"?e:()=>document.getElementsByClassName(e)[0])()));te(E,s.current),setTimeout(()=>{te(E,b)},0)}else er(E,s.current);l(y)},x=n?a:r;return(0,o.jsx)(x,{onClick:y=>p(!n,t)})};var wt=C(548),it={};it.styleTagTransform=T(),it.setAttributes=_(),it.insert=d().bind(null,"head"),it.domAPI=h(),it.insertStyleElement=v();var wa=i()(wt.Z,it);const $=wt.Z&&wt.Z.locals?wt.Z.locals:void 0,ar=({open:t,close:e,hasMask:r=!0,cancelText:a="\u53D6\u6D88",submit:n,submitText:l="\u786E\u5B9A",title:s="Modal \u5F39\u7A97",className:p,children:x,delay:y=250,...E})=>{const k=["modal-wrap",t?"open":"",...p?.split(" ")??[]].filter(Boolean).map(b=>$[b]).join(" ");return(0,o.jsx)(Dt,{open:t,close:e,delay:y,hasMask:r,className:"huxy-modal",children:(0,o.jsx)("div",{className:k,...E,children:(0,o.jsxs)("div",{className:$["modal-container"],children:[(0,o.jsx)("div",{className:$["modal-header"],children:s}),(0,o.jsx)("div",{className:$["modal-content"],children:x}),(0,o.jsxs)("div",{className:$["modal-footer"],children:[(0,o.jsx)("div",{className:`${$.btn} ${$.left}`,onClick:b=>e?.(b),children:a}),(0,o.jsx)("div",{className:`${$.btn} ${$.right}`,onClick:b=>n?.(b),children:l})]})]})})})};var vt=C(990),lt={};lt.styleTagTransform=T(),lt.setAttributes=_(),lt.insert=d().bind(null,"head"),lt.domAPI=h(),lt.insertStyleElement=v();var ka=i()(vt.Z,lt);const Ea=vt.Z&&vt.Z.locals?vt.Z.locals:void 0,Ot=({global:t,absolute:e})=>(0,o.jsx)("div",{className:`spinner${t?" global":""}${e?" absolute":""}`,children:(0,o.jsx)("figure",{className:"spinning"})});var kt=C(232),st={};st.styleTagTransform=T(),st.setAttributes=_(),st.insert=d().bind(null,"head"),st.domAPI=h(),st.insertStyleElement=v();var Pa=i()(kt.Z,st);const ct=kt.Z&&kt.Z.locals?kt.Z.locals:void 0,nr=t=>t?.filter?.(e=>typeof e=="function"),ir=(t,e)=>{const r=(0,m.useRef)(),{loading:a,title:n,plugins:l,children:s,className:p,...x}=t,y=nr(l),E=y?.length,k=p?` ${p}`:"",b=H(e)?e:r;return(0,o.jsxs)("div",{className:`${ct.panel}${k}`,...x,ref:b,children:[(n||E)&&(0,o.jsxs)("div",{className:ct["panel-header"],children:[n&&(0,o.jsx)("h4",{className:ct["panel-title"],children:n}),E&&(0,o.jsx)("div",{className:ct["panel-plugins"],children:y.map((M,R)=>(0,o.jsx)("span",{className:`link ${ct.link}`,children:(0,o.jsx)(M,{panel:b})},R))})]}),(0,o.jsx)("div",{className:ct["panel-body"],children:s}),a&&(0,o.jsx)(Ot,{})]})},lr=(0,m.forwardRef)(ir),Mt=t=>At(t)==="array",sr=t=>Mt(t)&&!!t.length,cr=({to:t,preventDefault:e,stopPropagation:r,...a})=>e?(0,o.jsx)("span",{...a}):(0,o.jsx)("a",{href:t,...a}),dr=({item:t,...e})=>(0,o.jsx)("ul",{...e}),hr=(t,...e)=>{const r={};return Object.keys(t).filter(Boolean).map(a=>{r[a]=n=>t[a](n,...e)}),r},ae=({data:t=[],events:e={},List:r=dr,Link:a=cr,leftIcon:n,rightIcon:l,isHorizontal:s,isCollapsed:p,level:x=0,parentOpen:y=!0})=>{const E=p&&!x,k=!s&&!p&&!y;return t.map(b=>{const{name:M,path:R,icon:P,rightIcon:S,active:A,open:D,children:W,linkProps:N}=b,Y=sr(W),B=b.id||R||M,X=E?b.title??M:void 0,L=k?"hidden":"",V=P??n,F=S??l,Q=V?(0,o.jsx)("div",{className:"node-left-icon",children:V===!0?(0,o.jsx)("i",{className:"default-left-icon"}):V}):null,zt=M?(0,o.jsx)("div",{className:"node-text",children:(0,o.jsx)("span",{children:M})}):null;if(Y){const Ur=hr(e,b,x),Nr=[L,D?"open":""].filter(Boolean).join(" ");return(0,o.jsxs)("li",{className:Nr,"has-children":"true",...Ur,children:[(0,o.jsxs)(a,{title:X,className:`link${A?" active":""}`,to:R,preventDefault:!0,stopPropagation:!1,...N,children:[Q,zt,F?(0,o.jsx)("div",{className:"node-right-icon",children:F===!0?(0,o.jsx)("i",{className:"default-right-icon"}):F}):null]}),(0,o.jsx)(r,{item:b,children:ae({data:W,events:e,List:r,Link:a,leftIcon:n,rightIcon:l,isHorizontal:s,isCollapsed:p,level:x+1,parentOpen:!!D})})]},B)}return(0,o.jsx)("li",{className:L,children:(0,o.jsxs)(a,{title:X,className:`link${A?" active":""}`,to:R,...N,children:[Q,zt]})},B)})},ne=ae,ur=(t,...e)=>(0,o.jsx)("div",{"v-html":t,...e});var Et=C(575),dt={};dt.styleTagTransform=T(),dt.setAttributes=_(),dt.insert=d().bind(null,"head"),dt.domAPI=h(),dt.insertStyleElement=v();var Da=i()(Et.Z,dt);const ja=Et.Z&&Et.Z.locals?Et.Z.locals:void 0,pr=t=>(0,o.jsx)("div",{style:{padding:"6px 15px"},children:t}),fr=({activekey:t,tabs:e=[],switchTab:r,trackColor:a,flex:n,...l},s)=>{const[p,x]=(0,m.useState)(t??e[0]?.key),[y,E]=(0,m.useState)({}),k=(0,m.useRef)({}),b=(0,m.useRef)();(0,m.useEffect)(()=>{const P=k.current[p];P&&M(P)},[]);const M=P=>{const{left:S,width:A}=rt(P),D=rt(b.current).left;E({left:S-D,width:A})},R=(P,S)=>{P.stopPropagation(),x(S),typeof r=="function"&&r(S),M(P.currentTarget)};return(0,o.jsxs)("div",{className:"tabs-header-wrap",...l,ref:s,children:[(0,o.jsx)("ul",{className:`tabs-header${n?" flex":""}`,ref:b,children:e.map(P=>(0,o.jsx)("li",{ref:S=>k.current[P.key]=S,className:`th-item${p===P.key?" active":""}`,onClick:S=>R(S,P.key),children:typeof P.renderTabs=="function"?P.renderTabs(P,p===P.key):pr(P.value)},P.key))}),(0,o.jsx)("div",{className:"th-track",style:{...y,color:a}})]})},xr=(0,m.forwardRef)(fr),mr=(t,e,r="id",a="children")=>{if(!Mt(t))return null;const n=l=>{for(let s=0,p=l.length;s<p;s++){const x=l[s];if(x[r]===e)return[x];if(Mt(x[a])){const y=n(x[a]);if(y)return[x].concat(y)}}};return n(t)},yr=t=>++t,gr=()=>{const[,t]=(0,m.useState)(0);return(0,m.useCallback)(()=>t(yr),[])},ie=t=>{const{children:e,open:r}=t;let a=0;if(r&&e?.length){a=e.length;let n=0;return e.map(l=>n+=ie(l)),a+n}return a},_r=({item:t,style:e,...r})=>(0,o.jsx)("ul",{style:{...e,"--count":ie(t)},...r});var Ct=C(942),ht={};ht.styleTagTransform=T(),ht.setAttributes=_(),ht.insert=d().bind(null,"head"),ht.domAPI=h(),ht.insertStyleElement=v();var Ia=i()(Ct.Z,ht);const Aa=Ct.Z&&Ct.Z.locals?Ct.Z.locals:void 0,br=t=>(0,o.jsx)("ul",{...t}),wr=(t,e)=>t?_r:({item:r,...a})=>(0,o.jsx)(br,{className:e==="right"?"left":"",...a}),vr=t=>{const{data:e=[],collapsed:r=!1,type:a="vertical",Link:n,width:l,bgColor:s,itemHeight:p,collapsedWidth:x,itemPadding:y,style:E,className:k,...b}=t,M=(0,m.useRef)(),R=(0,m.useRef)();(0,m.useEffect)(()=>()=>clearTimeout(M.current),[]);const P=gr(),S=a==="horizontal",A=!S&&r,D={onClick:(L,V)=>{if(L.stopPropagation(),!S&&!A){const F=mr(e,V.path,"path"),Q=F[F.length-1];Q.open=!Q.open,P()}},onMouseEnter:(L,V,F)=>{A&&!F&&(clearTimeout(M.current),R.current.style.width="var(--maxWidth)")},onMouseLeave:(L,V,F)=>{A&&!F&&(M.current=setTimeout(()=>R.current.style.width="",200))}},W=(S?["huxy-horizontal-tree",k]:["huxy-tree",k,A?"collapsed":""]).filter(Boolean).join(" "),{float:N,...Y}=b?.style??{},B={"--bgColor":s,"--itemHeight":p,"--nodeListWidth":l,...Y};S?(B["--itemPadding"]=y,B["--nodeFloat"]=N):(B["--width"]=l,B["--collapsedWidth"]=x);const X=wr(!S&&!A,N);return(0,o.jsx)("div",{ref:R,className:W,style:B,...b,children:(0,o.jsx)("div",{className:"huxy-tree-track",children:(0,o.jsx)("ul",{className:"huxy-tree-root",children:ne({data:e,events:D,List:X,Link:n,leftIcon:!0,rightIcon:!0,isHorizontal:S,isCollapsed:A})})})})},kr=()=>{const[t,e]=Ut(q());return(0,m.useEffect)(()=>{const r=()=>e(q());return window.addEventListener("resize",r,!1),()=>window.removeEventListener("resize",r,!1)},[]),t},le=({menu:t,curName:e,Link:r})=>t.map(a=>{const{path:n,name:l,open:s,children:p}=a,x=l===e;return p?.length?(0,o.jsxs)("li",{className:s?"open":"",children:[(0,o.jsx)(r,{to:{query:{name:l}},className:`link${x?" active":""}`,preventDefault:!0,children:(0,o.jsx)("span",{children:l})}),(0,o.jsx)("ul",{children:(0,o.jsx)(le,{menu:p,curName:l,Link:r})})]},n||l):(0,o.jsx)("li",{children:(0,o.jsx)(r,{to:{query:{name:l}},className:`link${x?" active":""}`,children:(0,o.jsx)("span",{children:l})})},n||l)}),Er=le,Cr=(t={})=>{const e={};return Object.keys(t).map(r=>{t[r]!=null&&(e[r]=t[r])}),e},Pr=(t=0,e)=>{K()&&(e=H(e)?e.current:e??window,e.scrollTo?.({top:t,behavior:"smooth"}))},zr=(t=()=>{},e=60)=>{let r=null;return function(...a){r||(t.apply(this,a),r=setTimeout(()=>r=null,e))}},Sr=(t,e=null,r=!1)=>[...t||[]].sort((a,n)=>{const l=e?a[e]:a,s=e?n[e]:n;return!isNaN(Number(l))&&!isNaN(Number(l))?r?s-l:l-s:typeof l=="string"&&typeof s=="string"?r?s.localeCompare(l):l.localeCompare(s):typeof l=="string"&&typeof s=="number"?r?-1:1:typeof l=="number"||typeof l=="string"?r?1:-1:r?-1:1}),Tr=()=>K()&&(window.pageYOffset??document.documentElement.scrollTop??document.body.scrollTop),Dr=({curName:t,itemList:e})=>{const r=(0,m.useRef)(!1),a=(0,m.useRef)(""),[n,l]=(0,m.useState)(t);return(0,m.useEffect)(()=>{if(e.current=Cr(e.current),!t){const x=Object.keys(e.current).map(y=>({name:y,offsetTop:e.current[y]?.offsetTop??0}));l(x[0]?.name)}let s=0,p=0;if(a.current!==t){a.current=t;const x=e.current[t];r.current=!0,x?(Pr(x.offsetTop),s=setTimeout(()=>r.current=!1,1050)):p=setTimeout(()=>{window.scrollTo?.({top:e.current[t]?.offsetTop??0,behavior:"instant"}),s=setTimeout(()=>r.current=!1,1050)},550)}return()=>{clearTimeout(s),clearTimeout(p),r.current=!1}},[t]),(0,m.useEffect)(()=>{const s=zr(()=>{if(!r.current){const x=Sr(Object.keys(e.current).map(y=>({name:y,offsetTop:e.current[y]?.offsetTop??0})),"offsetTop",!0).find(y=>y.offsetTop<Tr())?.name;a.current!==x&&(a.current=x,l(x))}});return window.addEventListener("scroll",s,!1),()=>window.removeEventListener("scroll",s,!1)},[]),[n]},jr=/!\[.*\]\((.*)\)/g,Or=async(t,e,r)=>{const a={};for(let n=0,l=t.length;n<l;n++){const s=t[n],p=s.slice(2);a[s]=await r({folder:e,name:p})}return a},Mr=async(t,{folder:e},r)=>{const n=[...t.matchAll(jr)].filter(Boolean).map(l=>l[1]);if(n?.length){const l=await Or(n,e,r);n.map(s=>{t=t.replace(s,l[s])})}return t},Rr=({item:t,marked:e,getContext:r})=>{const[a,n]=(0,m.useState)("");return(0,m.useEffect)(()=>{(async()=>{try{const s=await r({...t,type:".md"}),p=await Mr(s,t,r),x=typeof e=="function"?e.parse(p):x;n(x)}catch(s){n(s?.message)}})()},[]),(0,o.jsxs)("div",{className:"huxy-content",children:[jt(a),!a&&(0,o.jsx)(Ot,{global:!0})]})},Ir=({router:t,curName:e,context:r,marked:a,getContext:n})=>{const l=(0,m.useRef)({}),[s]=Dr({curName:e,itemList:l});return(0,m.useEffect)(()=>{s&&t.push({query:{name:s}})},[s]),(0,o.jsx)("div",{className:"huxy-anchor-page",children:r.map((p,x)=>(0,o.jsxs)("div",{className:"huxy-anchor-item",ref:y=>l.current[p.name]=y,children:[(0,o.jsx)("h2",{children:`${p.name}`}),(0,o.jsx)(Rr,{item:p,marked:a,getContext:n})]},p.name))})},Ar=t=>{const e=[];return t.map(r=>{const[a,n]=r.name.split("/"),l=e.find(s=>s.name===a);l?l.children.push({name:n,folder:a}):e.push({name:a,children:[{name:n,folder:a}]})}),e};var Pt=C(556),ut={};ut.styleTagTransform=T(),ut.setAttributes=_(),ut.insert=d().bind(null,"head"),ut.domAPI=h(),ut.insertStyleElement=v();var Xa=i()(Pt.Z,ut);const Ga=Pt.Z&&Pt.Z.locals?Pt.Z.locals:void 0,Wr=(t,e,r)=>({sidebar:t.find(a=>a.name===e)?.children??[],listEle:t.map(({name:a,children:n})=>(0,o.jsx)("li",{children:(0,o.jsx)(r,{to:{query:{folder:a,name:n[0]?.name}},className:`link${a===e?" active":""}`,children:(0,o.jsx)("span",{children:a})})},a))}),Br=t=>{const{params:e,router:r,Link:a,listFiles:n,getContext:l,marked:s,title:p,routeLink:x,routeName:y,className:E,style:k}=t,{folder:b,name:M}=e,{width:R}=kr(),[P,S]=(0,m.useState)([]),[A,D]=(0,m.useState)(!1);(0,m.useEffect)(()=>{(async()=>{const X=await n(),L=Ar(X);S(L),b||r.push({query:{folder:L[0]?.name,name:L[0]?.children[0]?.name}})})()},[]);const W=R<=1024,{sidebar:N,listEle:Y}=Wr(P,b,a);return(0,o.jsxs)("div",{className:`huxy-doc-frame ${E??""}`,style:k,children:[(0,o.jsxs)("div",{className:"huxy-doc-header",children:[(0,o.jsx)("div",{className:"huxy-doc-banner",children:p||"\u6587\u6863\u7CFB\u7EDF"}),(0,o.jsx)("ul",{className:"huxy-doc-nav",children:W?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("li",{className:"huxy-doc-collapsed",children:(0,o.jsx)("span",{className:"link",onClick:B=>{B.stopPropagation(),D(!A)},children:(0,o.jsx)(Rt,{type:A?"right":""})})}),(0,o.jsx)(Ft,{open:A,close:()=>D(!1),width:"220px",children:(0,o.jsx)("ul",{className:"huxy-doc-menu-drawer",children:Y})})]}):Y}),x?(0,o.jsx)("div",{className:"huxy-doc-back",children:(0,o.jsx)(a,{to:x,children:(0,o.jsx)("span",{children:y??"\u8FD4\u56DE\u4E3B\u9875"})})}):null]}),(0,o.jsxs)("div",{className:"huxy-doc-container",children:[(0,o.jsx)("div",{className:"huxy-doc-main-page",children:(0,o.jsx)(Ir,{router:r,curName:M,context:N,marked:s,getContext:l})}),(0,o.jsx)("div",{className:"huxy-doc-menu",children:(0,o.jsx)("ul",{className:"huxy-doc-menu-root",children:(0,o.jsx)(Er,{menu:N,curName:M,Link:a})})})]})]})}})();var Hr=z.PC,Kr=z.rK,Zr=z.lr,$r=z.JX,Vr=z.dy,Yr=z.Ud,Xr=z.mH,Gr=z.SV,Jr=z.Hn,Qr=z.rj,qr=z.V7,to=z.AN,eo=z.zd,ro=z.BQ,oo=z.Ur,ao=z.u_,no=z.s_,io=z.h_,lo=z.X2,so=z.$j,co=z.GK,ho=z.u,uo=z.mp,po=z.C2,fo=z.pC,xo=z.ff,mo=z.d2,yo=z.Uw;export{Hr as Anico,Kr as Base64Image,Zr as Carousel,$r as Col,Vr as Drawer,Yr as Drop,Xr as Ellipsis,Gr as ErrorBoundary,Jr as FullPage,Qr as Grid,qr as HandleError,to as LoadError,eo as Mask,ro as MaxSize,oo as Md2html,ao as Modal,no as Panel,io as Portal,lo as Row,so as Spinner,co as TabHeader,ho as Tooltip,uo as Tree,po as fixEle,fo as fixIcon,xo as renderTree,mo as str2React,yo as str2Vue};
